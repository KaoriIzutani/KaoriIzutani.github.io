function getReceipt() {
	/*Initializes our string, so it can get passed from function to function, growing line by line into a full
	 receipt*/
	var text1 = "";
	var text2 = "";
/*String that shows a list of selected items. The original string "<h3>You Ordered:</h3>" will get concatenated with 
the new string "Large Pizza<br>" to make up the new string value.*/
var runningTotal = 0;
var sizeTotal = 0; 
